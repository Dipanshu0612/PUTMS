  ...
  return (
    <>
      ...
      <div className='main max-h-min bg-slate-200 flex md:flex-col sm:flex-col p-3 sm:space-y-5 md:space-y-5'>
        <div className='bg-slate-100 h-[45rem] w-1/4 shadow-lg flex space-y-2 flex-col items-center py-3 overflow-hidden cursor-pointer md:w-full sm:w-full sm:m-0 mr-3'>
